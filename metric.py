...
class Metrics(object):
    ...
    def __init__(self, score_file_path,segment=10):
        super(Metrics, self).__init__()
        self.score_file_path = score_file_path
        self.segment = segment #It depend on positive negative ratio 1:1 or 1:9

    def __read_socre_file(self, score_file_path,shuffle=True):
        sessions = []
        one_sess = []
    ...
    def significant(self,sessions=None):
        all_map=[]
        all_mrr=[]
        all_p1=[]
        all_r1=[]
        ...
        for session in sessions:
            ...
            all_map.append(m_a_p)
            all_mrr.append(m_r_r)
            all_p1.append(p_1)
            all_r1.append(r_1)
            all_r2.append(r_2)
            all_r5.append(r_5)
        return all_map,all_mrr,all_p1,all_r1,all_r2,all_r5

        

    def evaluate_all_metrics(self,sessions=None):
        sum_m_a_p = 0
        sum_m_r_r = 0
        sum_p_1 = 0
        sum_r_1 = 0
