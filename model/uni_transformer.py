...
class Attention(nn.Module):
    def __init__(self, nx, n_ctx, scale=False, is_cross_attention=False):
        super().__init__()
...
class Block(nn.Module):
    def __init__(self, n_ctx, hidden_dim, scale=False):
        super().__init__()
        inner_dim = 4 * hidden_dim
        self.ln_1 = nn.LayerNorm(hidden_dim, eps=1e-5)
        self.attn = Attention(hidden_dim, n_ctx, scale)
        self.ln_2 = nn.LayerNorm(hidden_dim, eps=1e-5)
        self.mlp = MLP(inner_dim, hidden_dim)
